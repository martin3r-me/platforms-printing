{{-- Blätterung im Ton des Moduls – deutsch, nx-Farben.

     Die mitgelieferte Livewire-Ansicht bringt englischen Text mit („Showing 1
     to 25 of 42 results") und Tailwind-Grautöne, die neben den nx-Farben
     fremd wirken. Sie doppelt außerdem den Zähler, den die Listen links
     ohnehin zeigen.

     Deshalb hier nur die Navigation: Die Liste sagt, WAS gezählt wird
     („42 Aufträge", „12 Drucker"), diese Ansicht bringt einen nur woanders
     hin. Eingebunden über ->links('printing::partials.pagination').

     Gleiche Datei wie im Reservations-Modul – bewusst kopiert statt geteilt:
     die beiden Module haben keine gemeinsame Abhängigkeit, in der sie liegen
     könnte, und eine Blade-Ansicht mit zwanzig Zeilen ist der falsche Anlass,
     eine einzuführen.
